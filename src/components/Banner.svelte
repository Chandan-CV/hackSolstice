		...
		<div id="banner-img-container z-[7]" class="">
			<div class="align-middle flex flex-col mt-32">
				...
				>
					...
					<path
						class=" rotateinOnLoad2"
						d="M262.262 109.346L211.864 45.9868C199.258 30.1394 176.192 27.5114 160.345 40.117L96.9855 90.5152C81.138 103.121 78.51 126.187 91.1156 142.034L141.514 205.393C154.12 221.241 177.185 223.869 193.033 211.263L256.392 160.865C272.239 148.259 274.867 125.194 262.262 109.346Z"
						stroke="#AF6C99"
						stroke-opacity="0.75"
						stroke-width="9"
					/>
					<path
						class=" rotateinOnLoad3"
						d="M269.316 125.474L226.638 48.4814C216.758 30.6565 194.298 24.2163 176.473 34.0968L99.4809 76.7743C81.656 86.6548 75.2158 109.114 85.0963 126.939L127.774 203.932C137.654 221.757 160.114 228.197 177.939 218.316L254.931 175.639C272.756 165.758 279.196 143.299 269.316 125.474Z"
						stroke="#143E86"
						stroke-opacity="0.75"
						stroke-width="9"
					/>
					<path
						class=" rotateinOnLoad4"
						d="M247.567 75.252L176.165 37.2866C158.17 27.7187 135.826 34.5499 126.258 52.5445L88.2929 123.947C78.725 141.942 85.5562 164.285 103.551 173.853L174.953 211.819C192.948 221.387 215.292 214.555 224.86 196.561L262.825 125.158C272.393 107.164 265.562 84.8199 247.567 75.252Z"
						stroke="#6738BE"
						stroke-opacity="0.75"
						stroke-width="9"
					/>
				...
				<div
					id="countdownbox"
					class=" flex flex-col items-center text-center text-3xl font-semibold font-mono bg-clip-text text-transparent bg-gradient-to-r via-[#c04d26] from-[#772f9e] to-[#623bac] backgroundpan countFadeIn"
				>
					{dLeft}:{hLeft}:{mLeft}:{sLeft}
					<p class="text-white text-3xl">Manipal Institute of Technology, BENGALURU</p>
